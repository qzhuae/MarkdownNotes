...
**Model Overfitting**
- If the training set is small compared with the number of params, overfitting may occur. [How to quantify this?]
...
$L_2$ regularization is also called Tikhonov regularization 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEyNTc5MjAwMDUsLTE3ODI2MjAwMSwtMT

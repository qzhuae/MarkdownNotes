...
### Parametric over non-parametric
...
- Researched and Analysized other models

We have verified that the MStream algorithm proposed is indeed able to cluster short texts.

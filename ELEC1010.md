...
Harmonics are *sine waves at $n$ times the fundamental frequency*.  Adding harmonics together does not affect the fundamental frequency $f$ and period $T$. 
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTgxMjczNjE0Nyw0MTUzODMxOTEsLTIwNj

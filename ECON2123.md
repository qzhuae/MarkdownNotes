...
**Long run**: Few decades or more - accumulation of capital stock and growth in technology level. Still supply side factor, can not just rely on supply size (such as accumulation of capital) why not? Depending on the speed may not cover the long run.
It is important to know what "conditions" or "constraints" that an economy behaves as in short, medium and long run.
E.g.  When the economy has many idle capacity and labor, do you think it is under S/M/L run?
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTY2NjM5MDg1LC0xMjQxMjExMDg2LDI2Mj

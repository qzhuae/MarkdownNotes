...
Why we make such strong assumption. How to make the price change and then new result will come out. After midterm exam, price may change even if in the SR.

Assume that firms are willing to supply any amount of the good at a given price, P, and demand in that market. (why?) Not supply side constraint. 

Disposable income after you pay taxes to government. As a side note, supplementary reading on income approach. Income of factors of production, corporate income, profit. Indirect tax:

If you use income approach to measure GDP. 

direct tax: is directly levied on your income. In HK, it is called salary tax. Corporate income tax is also income tax. Other than direct tax, there are other consumption tax and etc. To prohibit consumption of alcohol, this go into indirect tax.

You minus Direct Tax you get disposable income. 

`Consumption function` Consumption is a function of disposable income, increasing function (+). Behavioral equations: general consumption behavior. Consumption is linear increasing function of disposable income.

c_0: Autonomous consumption or consumer confidence: Y_D is zero and disposible income is 0. You still have positive consumption. Consumer Confidence. Consumer are confident to consume. Will automatically happen. c_0 > 0 positive

c_1: Marginal Propensity to Consumer: Increase Y_D by 1 dollar, how many dollar of C increases. Value for c_1? should be increasing. c_1 should be positive but smaller than 1. There are two part of disposable income: consumption and saving part. Due to saving motivation. c_1 should be less than 1. 

[refresh 2] saving must be negative. `De-save` behavior. Choose negative account. Saving for this period is negative. It is possible you can borrow from other - borrowing and lending. 1.2.3.4 not correct

**Investment (I)**

We do have investment function but not in this chapter. this comes from the financial markets. Assume investment is given. Given variable: `exogenous` variable: cannot be explained in the current model. Investment should be function of something else maybe of something in the financial markets. 

Exogenous vs. Endogenous 

Consumption is consumption of Y_D. consumption is endogenous variable.

We cannot explain c_0 and c_1 using current model. Hence, c_0 and c_1 are exogenous. 

Y_d endogenous. 

**Government Spending (G)**
- G and T describes the fiscal policy of the government in a economy.
- Fiscal Policy: choice of taxes and spending by the government
- We also treat G and T are exogenous, but under different reasons for investment
- Governments do not behave with the same regularity as consumers or firms because they may have different objectives.

G is government spending. T is government income (revenue) 
G and T may not be equal to each other.

Balanced budget G and T is equal 

Can a government keep running a budget deficit? surplus is better or not. You will observe budget deficit. To fight financial crisis, cut tax. Stimulus plan from China is that increase G and trying to boost investment I in the economy.

 Determination of Equilibrium Output. Recall Z = C+I+G

Production = Demand or Supply = Demand. They will also produce according to demand. 

Keynesian Stimulus Plan, Must be of limited duration. 
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTQzMjAzMzYwNSw3MzgxODc0MjksMjA5ND
QyMjAwOCwxMjgwMjQzMTUsLTEyNDEyMTEwODYsMjYyMTk5NjMy
LC0xNzI4NjcyMTcxLC0xNjY4ODMwMjM4LDU5ODQ3MDIwMSwxMT
Q3MDIxNDIyLDE1NTczNTYwMTEsLTE4MjM3MjAwMjQsLTEzNjAz
MDU1NDldfQ==
-->
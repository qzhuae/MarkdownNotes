...
- GDP is the sum of the **valued added** in the economy during a given period.
	- Value added equals to the value of a firm's production minus the value of the intermediate goods it uses in production.


<!--stackedit_data:
eyJoaXN0b3J5IjpbLTk5ODUzMTUyMF19
-->
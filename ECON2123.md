...
E.g.  When the economy has many idle capacity and labor, do you think it is under S/M/L run? Medium Run.
Why time horizon is import in defining S/M/L?When time is long enough, prices can adjust to equilibrium. Few years, a decade or few decades just on a  rough basis.

How to use macroeconomics model to explain fact: Know which time horizon. 
<!--stackedit_data:
eyJoaXN0b3J5IjpbMjA3NjEyODg5MiwtMTI0MTIxMTA4NiwyNj

...
**Short run**: Up to a few years - change in output is mainly driven by change in demand. We can make some strong assumption, which can be later  demand determine output
**Medium run**: A decade - Output level is determined supply factors: Capital stock, size of labor force, technology level. supply determines output
**Long run**: Few decades or more - accumulation of capitla sotck and growth in technology level.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTg2MDk1ODc0MywtMTI0MTIxMTA4NiwyNj

...
**Investment (I)** This is different from financial investment. Sometimes called `fixed investment` is the purchase of **new** capital goods, which is the sum of nonresidential investment (e.g. new machineries) and res
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEwNTcwNDg0NSwxMjgwMjQzMTUsLTEyND
